...
\begin{equation}
\text{Siendo} P=(x_1,x_2,\ldots,x_n)\text{ y }Q=(y_1,y_2,\ldots,y_n) \in
\mathbb{R}^n
\text{La distancia Minkowski entre ambas instancias está definida por:}
...
es la denominada Manhattan, con p=2 es la distancia Euclídea.\\
