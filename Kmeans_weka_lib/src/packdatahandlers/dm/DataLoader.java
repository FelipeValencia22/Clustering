...

{
	...
	/**
	 * pre:Se recibe como parámetro el path de donde se encuentra el archivo
	 * La constructora comprueba que el path que le pasamos como parametro es correcto antes de 
	 * construir, tratando la excecepción correspondiente
	 * @param path
	 */
	...
	/**
	 * pre:recibe como parámetro las instancias a barajar.
	 * post:las mezcla con el filtro randomize.
	 */
	public void instanceShuffle(Instances pData)
	{
	...
	/**
	 * pre:el directorio fichero_datos debe existir en el directorio del proyecto?\TODO(revisar)
	 * @param test
	 * @throws IOException
	 ...
	 * @param CleanFileContent = boolean.Si true y existe el archivo borra el contenido, si false, añade el contenido al final del archivo.
